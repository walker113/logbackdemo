...
public class LiteAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    /**
     ...
     * @param event
     */
    private void parseEvent(ILoggingEvent event) {
...
//        ad_log.save();
    ...
    public void append(ILoggingEvent event) {
         ...
         * 带格式的内容、仅仅是信息的内容
         */
        String content = this.encoder.getLayout().doLayout(event);

        KLog.e(MDC.get("table") + " = " + content);
